...
UIFamilyPortlet.prototype.OpenPrivateField = function(elm) {
	if(elm === "DivCheckBox") {
...
UIFamilyPortlet.prototype.OverButton = function(oject) {
...
UIFamilyPortlet.prototype.expandCollapse = function(obj) {
...
eXo.family.UIFamilyPortlet = new UIFamilyPortlet() ;
